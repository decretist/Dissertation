...
(*tractatus decretalium epistolarum*).[^5]
...
ordinandorum*.[^7] Gratian at D.81 d.a.c.1 indicates that the
...
rubric, canon and *dictum post* terminal nodes.[^12]
...
were not added to the *Decretum* until the second recension.[^13]
...
liceat, sponsae a sponso recedere, et alii nubere?*[^14]
...
*Hic primum queritur* is the most common.[^15]
...
objective) has a distinctly contemporary feel to it.[^16]
...
[^6]: Distinctions 1-20 are usually referred to by modern scholars
...
[^7]: There are five internal references to the *tractatus ordinandorum* in the vulgate *Decretum*:  
...
[^8]: All of the empty questions contain a *dictum ante* (see below)
...
[^13]: **Confirm**. If these questions are missing altogether in
...
[^15]: The formulaic transition markers used in the hypothetical
...
[^16]: "Quidam habens filium ..." C.1, d.init., Friedberg 1.357.
