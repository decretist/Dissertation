...
claims advanced on behalf of Alexander Hamilton and James Madison.[8] In
...
numbers.[9] In 1964, Mosteller and Wallace confirmed Adair's findings by
...
attributed to Hamilton and Madison.[10]
...
the techniques discussed in this chapter.[15] The smallest unit of Latin
prose for which computational stylometry works is about 2,500 words.[16]
...
Winroth himself acknowledged the provisional nature of his appendix.[18]
...
recension ends with D.99 c.1.[19]
...
approach.[20] This method is well-theorized in Digital Humanities as
...
generate a "paratext."[21] The paratext is different from the original
...
completion for it to be used for my project.[22]
...
zum Decretum Gratiani* for the MGH.[23] Anders Winroth and Lou Burnard
...
origin stories for Digital Humanities as a discipline.[24] The success
...
e-text.[25] An error in D.23 c.2 is particularly noteworthy. Contrary to
...
*dicta* was implemented in the form of a 201-line Python program.[28]
...
C.19 d.init.[30] The second-recension version of the text of C.19
...
![Figure 0a updated 14 May 2020[32]](PNGs/Figure_0a.png)
...
Figures 0a and 0b represent the axes as orthogonal (perpendicular) to
...
the samples. This is not necessarily the case, and an advanced
technique, introduced below, called principal component analysis (PCA),
handles this problem in a more mathematically sophisticated way.
...
extended discussions of the phenomenon.[33] The rank-frequency
...
word.[34] In other words, the theoretical Zipf distribution predicts
...
implied fractional values of *a* for the most frequent words.[35] Zipf
...
continuous quantities.[36] Zipf also noted that value of the exponent of
b is likely to differ from 2 depending on the size of the corpus[37]
...
rank. (See Figure Zb below.) Note that the base of the logarithms does
...
theoretical Zipf distribution of word frequencies in Figure Zb, and
-0.6518 for the actual frequencies of the thirty most frequent words in
Gratian's *dicta* in Figure Zd.
...
reasonably well.[38] The rank-frequency relationship does not on first
...
words from Gratian's *dicta*.[39] (See Figure Zd below.) Transposing
...
[13] Hence, for the purposes of this study, the text of the *dicta* of
...
[14] Winroth, *The Making of Gratian’s Decretum*, 201. The numbers 1 and
...
[15] This paragraph may have to be moved to a separate section
...
[16] Maciej Eder, “Does Size Matter? Authorship Attribution, Small
Samples, Big Problem,” *Literary and Linguistic Computing* 30, no. 2
(June 2015): 171.

[17] Winroth, *The Making of Gratian’s Decretum*, 9–11. See also Stephan
...
[18] "The list is based on a collation of *incipits* and *explicits* of
...
[19] Kenneth Pennington, “The Biography of Gratian, the Father of Canon
Law,” *Villanova Law Review* 59 (2014): 685.

[20] Anders, my understanding is that you took a similar approach when
...
[21] Lisa Samuels and Jerome McGann, “Deformance and Interpretation,”
*New Literary History* 30, no. 1 (1999): 25–56.

[22] As of the 22 April 2019 version, eight case statements (for cases
...
[23] Timothy Reuter and Gabriel Silagi, eds., *Wortkonkordanz zum
Decretum Gratiani*, Monumenta Germaniae historica. Hilfsmittel 10
(München: Monumenta Germaniae Historica, 1990).

[24] Susan Hockey, “The History of Humanities Computing,” in *A
...
[25] Data current as of 18 May 2021. For more recent error reports, see
...
[26] Thanks to Anders Winroth for bringing the instance of homeoteleuton
...
[27] Anders Winroth, “Uncovering Gratian’s Original Decretum with the
Help of Electronic Resources,” *Columbia Library Columns* 46, no. 1
(1997): 26–31.

[28] Python is a widely-used general-purpose programming language.
...
[29] Hockey, “The History of Humanities Computing.”

[30] Winroth, *The Making of Gratian’s Decretum*, 216.

[31] Much of the analysis from this point forward will take advantage of
...
[32] The actual generation of Figure 0a was deferred until after the
...
[33] George Kingsley Zipf, *The Psycho-Biology of Language: An
...
[34] In Digital Humanities courses, 1/N is typically presented *as*
...
[35] "Hence the *a**b*<sup>2</sup> = *k* relationship is valid only for
...
[36] Zipf used the term "integrality" to describe the discrete,
discontinuous, nature of frequency and rank. Zipf, *Human Behavior and
the Principle of Least Effort*, 31, 35.

[37] Zipf, *The Psycho-Biology of Language*, 43.

[38] "we have found a clearcut correlation between the number of
...
[39] $m = \\frac{\\sum{x_iy_i - n\\bar{xy}}}{\\sum{x_i^2 - n\\bar{x}^2}}$
or:
