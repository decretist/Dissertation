...
France than we can easily explain.[^5]
...
and Nabor while working as a rubricator.[^7] Odofredus did not
...
evaluating historical evidence.[^9] Noonan's insistence on adhering
...
Gratian had a teaching career.[^10]
...
and "Moysis", in that order)[^12] advising a three-judge panel
...
intellectual evolution in a single generation.[^18]
...
a common practice in the early twelfth century, at Lateran II.[^25]
...
pre-Vulgate and Vulgate versions.[^27] Furthermore, the fact that
...
the figure of the author.[^29] Three examples from classical and
...
(†253).[^30] Quasi-monastic members of the episcopal household of
...
did Gratian's collaborators make to the project?[^33] There are a
...
Pennington[^34] reviewed in the preceding section tacitly assumes
...
readings in the theory of authorship.[^35]
...
considered supremely authoritative on precisely this kind of problem.[^43]
...
[^5]: See @kuttner_father_1941. Kuttner argues that Gratian applied
...
[^7]: Noonan identifies Odofredus as the source for associating
...
[^8]: See @noonan_gratian_1979, 150-151. @van_hove_prolegomena_1945
...
[^10]: R.W. Southern takes an extreme position with respect to
...
[^12]: Pennington reads a great deal into the order (why wasn't
...
[^18]: Winroth has since come to contextualize the differences
...
[^19]: Cite Winroth's dissertation, 345, where he appears
...
[^21]: See @eichbauer_gratians_2013 for a good recent overview of
these debates.
...
[^23]: See @larrainzar_borrador_1999, 601, for the number of canons
...
[^25]: **Placeholder for Pennington, Larson footnote** Pennington
...
[^29]: @odonnell_augustine_2005, 136, 139. The need for scribal or
secretarial support presupposes that authors create texts by dictating
them.

[^30]: John Anthony McGuckin, "The Life of Origen (ca. 186–255)" in
...
[^34]: @grebner_patronate_2007; @winroth_where_2013;
@pennington_biography_2014; and @pennington_biography_2018.

[^35]: @barthes_death_1977; and @foucault_what_1998.
...
[^44]: @foucault_what_1998, 214. Foucault claims to have derived
