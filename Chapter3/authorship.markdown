...
figure of the author.[4] Three examples from classical and late
...
authorial activities of Origen of Alexandria (†253).[5] Quasi-monastic
...
that "Gratian may have had an atelier of assistants,"[7] but that
...
any, did Gratian's collaborators make to the project?[8] There are a
...
Pennington[9] reviewed in the preceding section tacitly assumes that if
...
in the theory of authorship.[10]
...
child."[11] Barthes argues that authors cannot be Authors---no person or
...
quotations drawn from the innumerable centres of culture."[12]
...
> found, the text is 'explained' - victory to the critic.[13]
...
enunciation and every text is eternally written *here* and *now*")[14]
...
name? How does it function?"[15] and then goes on to observe:
...
> entirely modify the functioning of the author's name.[16]
...
[4] James Joseph O’Donnell, *Augustine: A New Biography*, 1st ed. (New
...
[5] John Anthony McGuckin, "The Life of Origen (ca. 186–255)" in *The
...
[7] Kenneth Pennington, “The Biography of Gratian, the Father of Canon
...
[9] Gundula Grebner, “Lay Patronate in Bologna in the first half of the
12th Century: Regular Canons, Notaries, and the Decretum,” in *Europa
...
[10] Roland Barthes, “The Death of the Author,” in *Image, Music, Text*,
...
[11] Barthes, “The Death of the Author,” 145.
...
[15] Foucault, “What Is an Author?” 209.
