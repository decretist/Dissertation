...
aspect of such an exponential pattern of growth is that it strongly
suggests that the earliest stages of the movement extended, beneath the
surface of visibility, for a significantly longer period of time than
surviving evidence would otherwise indicate.
