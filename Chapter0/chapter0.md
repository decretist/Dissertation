...
and controversial. **(See Figure 1 below.)**
...
had not written the case statements.

After a short while, however, I came to see the JPEG image output
by stylo as telling a very particular story---what Pennington would
call a "conjectural novella"---about the earliest origins of Gratian's
text, and by extension, about the dawn of the European university,
the moment when the medieval school started to evolve into an
organized faculty.
...
the corresponding passage from a published English translation.[^15]
...
[^15]: @jansen_medieval_2009; @somerville_prefaces_1998; and
